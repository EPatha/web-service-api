...
class BarangAdd extends StatefulWidget {
  const BarangAdd({Key? key}) : super(key: key);

  @override
  State<BarangAdd> createState() => _BarangAddState();
}

class _BarangAddState extends State<BarangAdd> {
  ...
  Future _onSubmit() async {
    try {
      return await http.post(
        Uri.parse("http://localhost:8080/barang/create.php"),
        body: {
          "NmBrg": nmBrg.text,
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            title: Text('Berhasil'),
            content: Text('Kode Barang: ${data["KdBrg"]}\n${data["message"]}'),
            actions: [
              TextButton(
                onPressed: () {
